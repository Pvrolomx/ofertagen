...
test('DOCX: modo solo-español (una columna)', files.generadorDocx?.includes('BORDERS_COL_SOLO') && files.generadorDocx?.includes('soloEs'));
...
test('PDF: tabla bilingüe', files.generadorPdf?.includes("['50%', '50%']"));
test('PDF: modo solo-español (una columna)', files.generadorPdf?.includes('soloEs') && files.generadorPdf?.includes("['100%']"));
