    ...
    // ---- CLÁUSULA 4: PRECIO Y CONDICIONES DE PAGO / PRECIO Y OBJETO ----
    {
      ...
      render: (ctx) => {
        ...
        if (ctx.bloques.precio_compuesto) {
          ...
          const mueblesEs = ctx.muebles?.objeto_es || 'el mobiliario, decoración y electrodomésticos que se encuentran dentro del inmueble';
...
B) COMPRAVENTA DE BIENES MUEBLES: El precio de la compraventa de ${mueblesEs} será la cantidad de ${pm.formateado} (${pm.letras}). Esta operación se formalizará por separado mediante ${convenioEs} con su respectivo inventario anexo${omisionEs}.`,
