...

    {
      ...
      render: (ctx) => {
        ...
        return {
          ...
          en: `${ctx._inciso}) That ${ctx.propietario.en.referencia} provide ${ctx.ofertante.en.referencia} a copy of the detailed inventory of the property (inclusion list), together with photographs thereof. ${ctx.propietario.en.referencia} is forbidden to remove or modify the content of the inventory from the date of acceptance of the present offer. The property shall be transferred with all furniture, fixtures and appliances included in said inventory. Said goods are transferred as accessories of the property and without separate consideration, forming part of the single agreed ad-corpus price.${exclEn}\n\nIn the event that THE PROPERTY is not delivered with the complete approved inventory, it shall be considered a breach by ${ctx.propietario.en.referencia}, who shall have 3 (three) calendar days to cure such default. Events of force majeure such as theft, hurricanes, storm surges or other events beyond ${ctx.propietario.en.referencia}'s control shall be excepted.`,
        };
      },
    },
