  ...
  bloques: [
    ...
    // ---- SUB-BLOQUE: ARRENDAMIENTOS VIGENTES ----
    {
      ...
      render: (ctx) => {
        ...
        return {
          es: `E) En caso de existir contratos de arrendamiento vigentes con posterioridad a la FECHA DE FORMALIZACIÓN, ${ctx.propietario.referencia} deberá informar a ${ctx.ofertante.referencia} de dichos contratos para que éste determine si los mismos se mantendrán en vigor. En caso afirmativo, ${ctx.propietario.referencia} abonará a ${ctx.ofertante.referencia} todas las rentas y depósitos programados con posterioridad a la FECHA DE FORMALIZACIÓN, y ${ctx.ofertante.referencia} estará obligado a respetar los contratos de arrendamiento vigentes. ${ctx.propietario.referencia} tendrá derecho a percibir las rentas ${rentaHastaEs}. ${ctx.propietario.referencia} no será responsable de las cancelaciones de renta por parte de los arrendatarios. La decisión de ${ctx.ofertante.referencia} sobre la continuidad de los contratos de arrendamiento deberá comunicarse al momento de constituir el depósito en garantía.`,
