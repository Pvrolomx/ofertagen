    ...
    // ---- SUB-BLOQUE 15B: DOCUMENTACIÓN (ESCRITURA O FIDEICOMISO) ----
    {
      ...
      render: (ctx) => {
        ...
        if (esMexicano) {
          ...
          return {
            es: `${ctx._inciso}) Que ${ctx.propietario.referencia} envíe a ${ctx.ofertante.referencia_negrita} copia completa de LA ESCRITURA PÚBLICA que ampara su propiedad sobre EL INMUEBLE a que hace referencia el punto 3 de la presente oferta${condoEs}, dentro de los ${diasEnt} (${diasEntNum}) días ${tipoEnt} siguientes a la aceptación de la presente oferta. ${ctx.ofertante.referencia} tendrá ${diasRev} (${diasRevNum}) días ${tipoRev} adicionales para revisar la documentación. En caso de identificar condiciones inaceptables, la oferta quedará sin efecto y el depósito será reembolsado íntegramente a ${ctx.ofertante.referencia}.`,
            en: `${ctx._inciso}) That ${ctx.propietario.en.referencia} send ${ctx.ofertante.en.referencia_negrita} a complete copy of THE PUBLIC DEED evidencing ownership of THE PROPERTY referred to in point 3 of this offer${condoEn}, within ${diasEntEn} (${diasEntNum}) ${tipoEntEn} days following acceptance of this offer. ${ctx.ofertante.en.referencia} shall have ${diasRevEn} (${diasRevNum}) additional ${tipoRevEn} days to review the documentation. If unacceptable conditions are identified, the offer shall be null and void and the deposit shall be refunded in full to ${ctx.ofertante.en.referencia}.`,
          };
        } else {
          ...
          return {
            ...
            en: `${ctx._inciso}) That ${ctx.propietario.en.referencia} send ${ctx.ofertante.en.referencia_negrita} a complete copy of THE ORIGINAL TRUST referred to in point 3 of this offer${condoEn}, within ${diasEntEn} (${diasEntNum}) ${tipoEntEn} days following acceptance of this offer. ${ctx.ofertante.en.referencia} shall have ${diasRevEn} (${diasRevNum}) additional ${tipoRevEn} days to review the documentation. If unacceptable conditions are identified, the offer shall be null and void and the deposit shall be refunded in full to ${ctx.ofertante.en.referencia}.`,
          };
        }
      },
    },
