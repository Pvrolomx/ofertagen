    ...
    // ---- SUB-BLOQUE 4B: SALDO ----
    {
      ...
      render: (ctx) => {
        ...
        return {
          ...
          en: `B) The balance, that is ${ctx.saldo.completo}, shall be paid ${ctx.bloques.escrow ? 'by wire transfer to the account assigned by the escrow company, ' : ''}at least ${ctx.precio.dias_saldo_letras_en} (${ctx.precio.dias_saldo}) business days prior to THE FORMALIZING DATE which is stipulated below.${usdEn}`,
        };
      },
    },
