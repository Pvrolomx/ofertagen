    ...
    // ---- SUB-BLOQUE 4B: SALDO ----
    {
      ...
      render: (ctx) => {
        const usdEs = ctx.precio.moneda === 'USD'
          ? `\n\nEl precio y los pagos permanecen denominados y pagaderos en dólares de los Estados Unidos de América; las fluctuaciones cambiarias no modificarán dicho precio y las comisiones bancarias no reducirán la cantidad neta acreditable al mismo. El Impuesto Sobre la Renta, así como las exenciones y deducciones aplicables, se convertirán a moneda nacional conforme al tipo de cambio legal que corresponda en la fecha de la operación, según lo determine el fedatario conforme a la ley.`
          : '';
        const usdEn = ctx.precio.moneda === 'USD'
          ? `\n\nThe price and payments remain denominated and payable in US Dollars; exchange-rate fluctuations shall not modify said price and bank fees shall not reduce the net amount credited to it. The Income Tax, as well as any applicable exemptions and deductions, shall be converted to Mexican pesos at the legal exchange rate applicable on the date of the transaction, as determined by the Notary under law.`
          : '';
        return {
